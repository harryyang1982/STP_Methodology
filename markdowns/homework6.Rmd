...
In this study, I'll see the descriptive statistics from word count, plot them as word clouds and some bar plots, and conduct network analysis with the Feature co-occurrence matrix. After doing them, I'll figure out the most and least frequent words and the relationships among terms (stemmed).